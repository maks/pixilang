...
#define DECOR_FLAG_MINIMIZED		( 1 << 4 )
...
struct sundog_event
{
    ...
    uint16_t	    	key; //virtual key code (ASCII 0..127) OR additional key code (see KEY_xxx defines)
...
struct window_manager
{
    ...
    ticks_hr_t 		ticks_per_frame;
    ticks_hr_t 		prev_frame_time;
    ...
    int 		auto_repeat;
    Atom 		delete_message;
    Atom		sel_atom_clipboard;
    Atom		sel_atom_xsel_data;
