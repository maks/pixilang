...
{
    dialog_data* data = (dialog_data*)user_data;
    ticks_t t = stime_ticks() - data->timer_start;
    t = ( t * 256 ) / stime_ticks_per_second() + 256 + 128;
...
void dialog_reinit_items( WINDOWPTR pwin, bool show_and_focus ) //pwin = dialog handler or decorator with dialog
{
