...
System: (most of these defines will be set automatically)
  ...
  CPUMARK		//0..10: 0 - slow CPU (e.g. 100 MHz ARM without FPU); 10 - fast CPU (e.g. Intel Core)
...
//HARDFP : (32bit only) __ARM_PCS_VFP
...
#ifndef ARCH_NAME
    #if defined(i386) || defined(__i386) || defined(__i386__) || defined(__i486__) || defined(__i586__) || defined(__i686__) || defined(_M_X86) || defined(_X86_)
	...
	#endif
    #endif
    #if defined(__aarch64__) || defined(__arm64__) || defined(__ARM_ARCH_ISA_A64)
...
#if __cplusplus >= 201103L || defined(__GCC_HAVE_SYNC_COMPARE_AND_SWAP_4)
    #include <atomic>
