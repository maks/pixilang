...
extern vorbis_dsp_state *tremor_vorbis_dsp_create(vorbis_info *vi);
extern void     tremor_vorbis_dsp_destroy(vorbis_dsp_state *v);
extern int      tremor_vorbis_dsp_headerin(vorbis_info *vi,vorbis_comment *vc,
				    ogg_packet *op);

extern int      tremor_vorbis_dsp_restart(vorbis_dsp_state *v);
extern int      tremor_vorbis_dsp_synthesis(vorbis_dsp_state *vd,
				     ogg_packet *op,int decodep);
extern int      tremor_vorbis_dsp_pcmout(vorbis_dsp_state *v,
				  ogg_int16_t *pcm,int samples);
extern int      tremor_vorbis_dsp_read(vorbis_dsp_state *v,int samples);
extern long     tremor_vorbis_packet_blocksize(vorbis_info *vi,ogg_packet *op);
